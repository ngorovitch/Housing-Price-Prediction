...
#%%
#import data
train = pd.read_csv('C:/Users/ngoro/OneDrive/Desktop/SAPIENZA/FUNDAMENTALS OF DATA SCIENCE AND LABORATORY/FDS FINAL PROJECT PYTHON/train.csv')
test = pd.read_csv('C:/Users/ngoro/OneDrive/Desktop/SAPIENZA/FUNDAMENTALS OF DATA SCIENCE AND LABORATORY/FDS FINAL PROJECT PYTHON/test.csv')
#%%
...
full['TotalSF'] = full['TotalBsmtSF'] + full['2ndFlrSF']
#%%
